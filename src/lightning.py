...
import os
from .datasets import MelanomaDataset, MelanomaDataset_2
...
class MelanomaSystem_2(pl.LightningModule):
    def __init__(self, net, cfg, img_paths, train_df, test_df, transform, experiment):
        super(MelanomaSystem_2, self).__init__()
        self.net = net
        self.cfg = cfg
        self.img_paths = img_paths
        self.train_df = train_df
    ...
    def prepare_data(self):
        ...
        self.train_dataset = MelanomaDataset_2(train, self.img_paths['train'], self.transform, phase='train')
        self.val_dataset = MelanomaDataset_2(val, self.img_paths['train'], self.transform, phase='val')
        self.test_dataset = MelanomaDataset_2(self.test_df, self.img_paths['test'], self.transform, phase='test')
