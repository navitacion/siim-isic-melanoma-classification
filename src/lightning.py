...
class MelanomaSystem(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        step = batch_idx + self.epoch_num * (len(self.train_dataset) // self.cfg.train.batch_size)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        # batch_idx + Epoch * Iteration
        step = batch_idx + self.epoch_num * (len(self.val_dataset) // self.cfg.train.batch_size)
